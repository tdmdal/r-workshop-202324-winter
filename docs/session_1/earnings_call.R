# a simple sentiment analysis of MSFT Q2 2024 earnings call transcript
...
# 1) "import" data
# scrape Microsoft's q2 2024 earnings call transcript from the motley fool
msft_q2_2024_url <- "https://www.fool.com/earnings/call-transcripts/2024/01/31/microsoft-msft-q2-2024-earnings-call-transcript/"
raw_html <- read_html(msft_q2_2024_url)
...
# modify the below line depending on how you installed Python and 
# setup your Python virtual environment for the transformers package
